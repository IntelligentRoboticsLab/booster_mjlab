...
class ReplayBuffer(nn.Module):
    ...
    def sample(self, batch_size: int) -> dict[str, torch.Tensor]:
        ...
        Returns a flat dict with keys: observations, actions, rewards, dones,
        truncations, next_observations, effective_n_steps.
        """
    ...
    def _sample_1step(self, batch_size: int, valid: int) -> dict[str, torch.Tensor]:
        ...
        return {
            ...
            "next_observations": torch.gather(
                self.next_observations, 1, obs_idx
    ...
    def _sample_nstep(self, batch_size: int, valid: int) -> dict[str, torch.Tensor]:
        ...
        n_step_rewards = (all_rewards * done_masks * discounts.view(1, 1, -1)).sum(
            dim=2
        )
        ...
        result = {
            ...
            "truncations": self.truncations.gather(1, final_next_obs_indices).reshape(
                flat
            ),
